...
/*   Updated: 2019/03/14 17:52:31 by agiordan    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int		open_window(t_win *win)
{
	...
	if (!(win->textures.tab[0] = SDL_LoadBMP("./ressource/lubrun.bmp")) ||\
		!(win->textures.tab[1] = SDL_LoadBMP("./ressource/superman.bmp")) ||\
		!(win->textures.tab[2] = SDL_LoadBMP("./ressource/simple_wall.bmp")) ||\
		!(win->textures.tab[3] = SDL_LoadBMP("./ressource/bois.bmp")) ||\
