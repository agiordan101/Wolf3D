...
int					ed_init_map_ui(t_win win, t_ui *map_ui,\
									Uint32 *map_ui_color);
int					ed_update_map_ui(t_win *win, t_editor *editor,\
										t_dot_2d shift);
...
void				ed_draw_map_ui(t_win *win, Uint32 *map_ui_color,\
									t_ui *map_ui);
int					ed_drag_x_shift(int x, int end, int unit);
int					ed_drag_y_shift(int y, int end, int unit);
int					**ed_resize_x(int **tab, int x_shift,\
									t_len len, int drag_flag);
void				ed_scroll_resize_x(t_dot_2d *pos, int unit,\
										int x_shift, int drag_flag);
int					**ed_resize_y(int **tab, int y_shift,\
									t_len len, int drag_flag);
void				ed_scroll_resize_y(t_dot_2d *pos, int unit,\
										int y_shift, int drag_flag);
...
void				raycasting(t_win *win, t_player *player,\
															t_calculs *calculs);
double				calcul_dist(t_win *win, t_player *player,\
															t_calculs *calculs);
